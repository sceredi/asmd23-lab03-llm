...
/**
 * Models a timetable, a table in which each row reports the number of hours (>=
 * 0) spent in each activity, and each column represents a given day. Though not
 * strictly necessary, a timetable implementation may be immutable.
 */
public interface Timetable {
	 ...
	 * @param activity
	 * @param day
	 * @return a new timetable similar to 'this', but with an additional hour
	 *         on @activity at the given @day
	 */
